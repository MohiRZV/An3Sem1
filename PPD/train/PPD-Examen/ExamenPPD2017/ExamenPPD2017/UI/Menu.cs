...
namespace ExamenPPD2017.UI
{
    ...
    public class Menu
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExamenPPD2017.UI.Menu"/> class.
        /// </summary>
        public Menu()
        {
            ...
            AddCommand("help", "Print the command list", PrintCommandList);
        }
